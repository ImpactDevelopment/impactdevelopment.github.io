...
import HeroMp4 from '../images/preview.mp4';
import HeroWebm from '../images/preview.webm';
import HeroVideoFrame from '../images/preview.jpg';
import HeroVideoPlaceholder from '../images/preview-placeholder.jpg';
...
function Home({ theme }) {
  ...
  return (
    <HomeContainer>
      <HomeHero
        appName="Impact Client"
        title="Customize your game"
        description={
          `Impact Client is an advanced utility mod for Minecraft based on ClientAPI, including a large number of useful mods.`
        }
      />
      <PreviewSection>
        ...
        <PreviewSectionDetail>
          <PreviewSectionDetailRow>
            <a target="_blank" rel="noopener noreferrer" href="https://evassmat.com/K4Bu"><PreviewSectionDetailIcon icon="windows" /></a>
            <a target="_blank" rel="noopener noreferrer" href="https://evassmat.com/K46L"><PreviewSectionDetailIcon icon="java" /></a>
          </PreviewSectionDetailRow>
          <PreviewSectionDetailText aria-label="All platforms are currently supported">Currently supported</PreviewSectionDetailText>
        </PreviewSectionDetail>
...
const HomePreviewContainer = styled(HomePreview)`
  transform: translate3d(120px, 0, 0);
  opacity: 0;
...
const PreviewSectionDetailIcon = styled(Icon)`
  ...
  background: ${props => props.theme.colorWhite(0.8)};
  border-radius: 50%;
  padding: 5px;

  :hover, :active, :visited {
    background: ${props => props.theme.colorWhite(1)};
  }
